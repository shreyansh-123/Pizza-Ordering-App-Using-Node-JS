...
var showqty = document.querySelector('#show-qty');
var orderplaced = document.querySelector('#success-alert');
var Updatecart = function Updatecart(data) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/update-cart', data).then(function (e) {
